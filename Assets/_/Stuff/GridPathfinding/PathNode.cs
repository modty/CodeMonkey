...
namespace GridPathfindingSystem {
    ...
    public class PathNode {
        ...
        public GridPathfinding.Axis axis;
        //public Transform trans;
        //public int layerMask = 1 << 9;

        public PathNode(int _xPos, int _yPos, GridPathfinding.Axis _axis) {
            xPos = _xPos;
            yPos = _yPos;
            axis = _axis;
        ...
        public override string ToString() {
            if (axis == GridPathfinding.Axis.XY) {
        ...
        public Vector3 GetWorldVector(Vector3 worldOrigin, float nodeSize) {
            if (axis == GridPathfinding.Axis.XY) {
                ...
                return worldOrigin + new Vector3(xPos * nodeSize, 0, yPos * nodeSize);
            }
        }
    }
