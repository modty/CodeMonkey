...
public class UnitGridCombat : MonoBehaviour {
    ...
    private void Awake() {
        ...
        healthBar = new World_Bar(transform, new Vector3(0, 15), new Vector3(10, 1.3f), Color.grey, Color.red, 1f, 10000, new World_Bar.Outline { color = Color.black, size = .5f });
    ...
    public void Damage(UnitGridCombat attacker, int damageAmount) {
        ...
        DamagePopup.Create(GetPosition() + new Vector3(0, 6), damageAmount, false);
